...
// Create a typed easing function (expo-ish easeOut)
const easeOutExpo = cubicBezier(0.16, 1, 0.3, 1);

export default function HomePage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-linear-to-tr from-[#04101c] via-[#0b1624] to-[#101c2c] text-white">
      {/* Background */}
      <div className="absolute inset-0 -z-10">
        <Aurora opacity={0.45} speed={0.5} blur={180} />
      ...
      <motion.section
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, ease: easeOutExpo }}
        className="relative flex flex-col items-center justify-center text-center px-6 pt-32 pb-24 max-w-3xl mx-auto"
      >
