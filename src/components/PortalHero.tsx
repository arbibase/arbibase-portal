      ...
      <main className="mx-auto grid w-full max-w-[1100px] place-items-center px-6 py-10 md:py-20">
        ...
        >
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-xs text-slate-400">
            ...
            <Link href="https://arbibase.com/privacy" className="hover:text-white">Privacy</Link>
            <span className="opacity-30">•</span>
            <Link href="https://status.arbibase.com" className="hover:text-white">Status</Link>
          </div>
